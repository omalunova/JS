...
document.wrapper.classList.add('wrap', 'collapse', 'alpha', 'beta');
...
for (const arrC of coursesAndDurationArray) {
     ...
     h1.innerText = arrC.title;
     p.innerText = arrC.monthDuration;
     div.append(h1, p);
